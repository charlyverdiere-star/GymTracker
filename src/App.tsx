  ...
  return (
    <div className="bg-black min-h-screen font-sans text-zinc-100 selection:bg-blue-500/30 select-none">
      <div className="max-w-md mx-auto min-h-screen bg-zinc-950 shadow-2xl overflow-hidden relative border-x border-zinc-900">
        <style>{`.dark-scrollbar::-webkit-scrollbar { width: 6px; height: 6px; } .dark-scrollbar::-webkit-scrollbar-track { background: #18181b; border-radius: 8px; } .dark-scrollbar::-webkit-scrollbar-thumb { background-color: #3f3f46; border-radius: 20px; border: 1px solid #18181b; } .dark-scrollbar { scrollbar-width: thin; scrollbar-color: #3f3f46 #18181b; }`}</style>
